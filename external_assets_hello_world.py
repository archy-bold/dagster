...
from external_lib import create_dummy_asset
...
defs = Definitions(assets=[create_dummy_asset(external_one_asset), create_dummy_asset(external_two_asset)], jobs=[my_job])
